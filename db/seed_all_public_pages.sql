...
VALUES
  (gen_random_uuid(), 'about.hero.arabicHeading', 'من نحن', 'من نحن', 'about', 'About hero Arabic heading'),
  ...
  (gen_random_uuid(), 'about.visionMission.heading', 'Vision, Mission & Objectives', 'الرؤية والرسالة والأهداف', 'about', 'About vision and mission heading'),
  (gen_random_uuid(), 'about.visionMission.subheading', 'Our guiding principles', 'مبادئنا الموجهة', 'about', 'About vision and mission subheading'),
  (gen_random_uuid(), 'about.orgChart.heading', 'Organizational Structure', 'الهيكل التنظيمي', 'about', 'About organizational chart heading'),
  ...
  (gen_random_uuid(), 'contact.form.namePlaceholder', 'Your name', 'اسمك', 'contact', 'Contact form name placeholder'),
  (gen_random_uuid(), 'contact.form.emailPlaceholder', 'Your email', 'بريدك الإلكتروني', 'contact', 'Contact form email placeholder'),
  (gen_random_uuid(), 'contact.form.subjectPlaceholder', 'Subject', 'الموضوع', 'contact', 'Contact form subject placeholder'),
  (gen_random_uuid(), 'contact.form.messagePlaceholder', 'Your message', 'رسالتك', 'contact', 'Contact form message placeholder'),
...
WITH managed_page_sections AS (
  ...
  JOIN (
    VALUES
      ...
      ('newsletter', 'hero', '{"maxWidth":"max-w-5xl"}'::jsonb, '{"title":"Stay Connected","subtitle":"Subscribe to receive news, events, and updates from the society."}'::jsonb, '{"backgroundColor":"bg-soil-dark","padding":"py-16","textColor":"text-white"}'::jsonb, 0, 'ALWAYS', false, NULL::varchar),
...
-- ========================================================================
-- Remove legacy homepage sections that are no longer part of the intended public home flow.
DELETE FROM site_sections
WHERE location = 'homepage'
  AND slug IN ('features-grid', 'testimonials', 'contact-form');
...
VALUES
  (
    ...
    '{"backgroundColor":"bg-soil-dark","padding":"py-24","textColor":"text-white"}'::jsonb,
    0,
    true,
    NOW(),
    NOW()
  ...
  (
    ...
    'text',
    '{}'::jsonb,
    '{"title":"About SSSSY","content":"<p>The Syrian Soil Science Society is a professional organization dedicated to the advancement of soil science in Syria. We bring together researchers, educators, students, and practitioners working across soil science and related fields.</p><p>Our mission is to promote sustainable soil management, support research and education, and strengthen scientific collaboration for the future of Syria''s land resources.</p>"}'::jsonb,
    '{"backgroundColor":"bg-white","padding":"py-16","textColor":"text-gray-900"}'::jsonb,
    10,
    true,
    NOW(),
    NOW()
  ...
  (
    ...
    '{"backgroundColor":"bg-gray-50","padding":"py-16","textColor":"text-gray-900"}'::jsonb,
    40,
    true,
    NOW(),
    NOW()
  ...
  (
    ...
    'homepage',
    'columns',
    '{"columns":2,"maxWidth":"max-w-6xl"}'::jsonb,
    '{"title":"Get Involved","items":[{"title":"Become a Member","content":"Join the Syrian Soil Science Society and connect with fellow soil scientists, access resources, and contribute to the advancement of soil science in Syria.","icon":"👥"},{"title":"Contact Us","content":"Have questions, suggestions, or want to collaborate? Get in touch with our team.","icon":"✉"}]}'::jsonb,
    '{"backgroundColor":"bg-soil-cream/30","padding":"py-16","textColor":"text-gray-900"}'::jsonb,
    50,
    true,
    NOW(),
    NOW()
...
VALUES
  ...
  (gen_random_uuid(), '00000000-0000-0000-0000-000000000001', 'البحث', 'Search', '/search', '_self', 11, true);
